...
<template>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="text-dark mb-0">Dashboard</h3><a class="btn btn-primary btn-sm d-flex align-items-center" role="button" href="#"><i class="fas fa-download fa-sm text-white-50"></i><span class="d-none d-md-block" style="margin-left: 5px;">Générer un rapport</span></a>
    </div>
    <div class="row">
