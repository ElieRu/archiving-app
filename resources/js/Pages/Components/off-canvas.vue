...
<template>
    <div
        id="offcanvas-menu"
        class="offcanvas offcanvas-start bg-body d-sm-block"
        tabindex="-1"
    >
        <div class="offcanvas-header">
            <Link
                ...
                >
                    ...
                    ></path></svg
                ><span class="fs-5">Regideso</span></Link
            ><button
                class="btn-close"
                type="button"
                ref="closeBtn"
