    ...
    >
        <div class="container-fluid d-flex flex-column p-0">
            ...
            <ul id="accordionSidebar" class="navbar-nav text-light">
                <li class="nav-item">
                    <Link class="nav-link d-flex align-items-center" href="/"
                        ><svg
                            xmlns="http://www.w3.org/2000/svg"
                        ...
                        >
                            ...
                            ></path></svg
                        ><span style="margin-left: 5px">Dashboard</span></Link
                    >
                </li>
                <li class="nav-item">
                    <Link
                        ...
                        >
                            ...
                            ></path></svg
                        ><span style="margin-left: 5px">Documents</span></Link
                    >
                </li>
                <li class="nav-item">
                    <Link
                        ...
                        >
                            ...
                            ></path></svg
                        ><span style="margin-left: 5px">Archivage</span></Link
                    >
                </li>
                <li class="nav-item">
                    <Link
                        ...
                        >
                            ...
                            ></path></svg
                        ><span style="margin-left: 5px">Services</span></Link
                    >
                </li>
                <li v-if="role === 'admin'" class="nav-item">
                    <Link
                        ...
                        >
                            ...
                            ></path></svg
                        ><span style="margin-left: 5px">Agents</span></Link
                    >
                </li>
                <li class="nav-item">
                    <Link
                        ...
                        >
                            ...
                            ></path></svg
                        ><span style="margin-left: 5px">A propos</span></Link
                    >
                </li>
            </ul>
        </div>
