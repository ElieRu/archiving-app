...
<template>
    <div id="properties-modal" class="modal fade" role="dialog" tabindex="-1">
                            ...
                            <div class="row">
                                <div class="col">
                                    <ul class="list-unstyled">
                                        <li style="font-size: 13px">Name</li>
                                        <li style="font-size: 13px">Type</li>
                                        <li style="font-size: 13px">Size</li>
